...
/////////////////////////////////////////////////////////////////////////////////////////////////
function PhysicalVolume (entity) {
    Component.call(this, entity);
}
PhysicalVolume.prototype = Object.create(Component.prototype);
PhysicalVolume.prototype.constructor = PhysicalVolume;

PhysicalVolume.prototype.receive = function(message) {
    if(message instanceof Presence) {
        if (message.who.entityName === this.entity.entityName){
            console.log( this.entity.entityName + " has phisycal volume");
        }
    }
};
...
var movable = function () { return new Movable ();};
var physicalVolume = function () { return new PhysicalVolume(); };

// entities in the game
var link = new Entity("link", EntityType.GOOD, [attacker(), defender(), sleepy(),life(), healer()]);
var ganon = new Entity("ganon", EntityType.EVIL, [attacker(), defender(), life(), healer()]);
var octorok = new Entity("octorok", EntityType.EVIL, [defender(), sleeper(), life(), healer()]);
var armos = new Entity("armos", EntityType.EVIL, [attacker(), life()]);
var movon = new Entity("movon", EntityType.EVIL, [movable()]);
var physicon = new Entity ("physicon", EntityType.EVIL, [physicalVolume()]);
var movphsicon = new Entity ( "movphsicon", EntityType.EVIL, [movable(), physicalVolume()]);

// we create the game with the entities
var game = new Game([link, ganon, armos, octorok, movon, physicon, movphsicon]);
